...
type onCompleteType = (arg0: ProgressEvent<EventTarget>, arg1: File) => void;
type onErrorType = (arg0: ProgressEvent<EventTarget>, arg1: File) => void;
type onProgressType = (
  arg0: {
    loaded: any;
    total: number;
...
export const updateFileElement = (fileObject) => {
  const [
    {
      children: [
        {
